...
const TeacherViewAssignments = ({navigation}) => {
      ...
      let listItemView = (item) => {
        return (
          <View
            ...
            <Text style={styles.text}>Id: {item.a_id}</Text>
            ...
            <Text style={styles.text}>Assignment File link: {item.a_link}</Text>
            <Text style={styles.text}>submission link: {item.a_upload}</Text>
